...
class restore_logstore_last_updated_course_module_subplugin extends restore_tool_log_logstore_subplugin {
    ...
    protected function define_logstore_subplugin_structure() {
        ...
        if (!in_array('logstore_last_updated_course_module', $enabledlogstores)) {
        ...
        $elepath = $this->get_pathfor('/logstore_lastupdated_log');
     ...
     */
    public function process_logstore_last_updated_course_module_log($data) {
        global $DB;
        // Need to have contextid.
        ...
        if ($data) {
            ...
            if ($data->contextlevel == CONTEXT_MODULE) {
                ...
                $newdata->lasttimeupdated = $data->lasttimeupdated;
                $DB->insert_record('logstore_lastupdated_log', $newdata);
            }
