...
/**
 * logstore_last_updated_course_module backup restore tests.
 *
...
class logstore_last_updated_course_moodle_backup_restore_testcase extends advanced_testcase {
    private $course;
    private $module;

    public function test_backup_restore() {
        global $DB, $CFG;
        $CFG->logstore_user_patch = 1;
        $this->resetAfterTest();
        $this->setAdminUser();
        $this->setup_datas();
        // Add log datas.
        ...
        // Retrieve cmid.
        $dbrecords = $DB->get_records('logstore_lastupdated_log', array('cmid' => $newmodule->id));;
